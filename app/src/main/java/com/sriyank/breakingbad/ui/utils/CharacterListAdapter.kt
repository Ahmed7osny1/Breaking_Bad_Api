package com.sriyank.breakingbad.ui.utils
...
import com.sriyank.breakingbad.databinding.ItemCharacterBinding
...
class CharacterListAdapter(private val clickCallBack: ((BreakingBadCharacter) -> Unit)?) :
    ...
    class CharacterViewHolder(val binding: ItemCharacterBinding) :
        ...
        private val tvCharacterName: TextView =
            itemView.findViewById(R.id.tvCharacterName)
        private val tvCharacterNickName: TextView =
            itemView.findViewById(R.id.tvCharacterNickName)
        private val tvCharacterBirthday: TextView =
            itemView.findViewById(R.id.tvCharacterBirthday)
        private val tvCharacterOccupation: TextView =
            itemView.findViewById(R.id.tvCharacterOccupation)
        private val tvCharacterStatus: TextView =
            itemView.findViewById(R.id.tvCharacterStatus)
        private val ivCharacterImage: ImageView =
            itemView.findViewById(R.id.ivCharacterImage)
